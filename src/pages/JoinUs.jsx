  ...
  return (
    <section className="join-container py-12 md:py-20 px-4 md:px-6 max-w-[1100px] mx-auto text-center font-['Inter',_sans-serif] bg-[radial-gradient(circle_at_top_right,_#f0f9f8_0%,_transparent_40%)]">
      ...
      <div className="join-hero mb-16 md:mb-20 animate-[fadeInDown_0.8s_ease-out]">
        ...
        <button className="cta-button bg-gradient-to-br from-[#436d6d] to-[#2f5d62] text-white px-8 md:px-12 py-3 md:py-4 rounded-full text-base md:text-lg font-semibold shadow-[0_10px_20px_rgba(47,93,98,0.2)] hover:shadow-[0_15px_30px_rgba(47,93,98,0.3)] hover:-translate-y-1 transition-all duration-300">
          Get Involved Now
        </button>
      </div>

      {/* Ways to Help Grid - Fully Responsive */}
      ...
      {/* Invitation Section - Responsive Design */}
