  ...
  return (
    <div className="bg-[#C9E3E0] text-[#2E5658] min-h-screen flex flex-col">
      ...
      <section className="flex flex-col md:flex-row items-center justify-center px-6 sm:px-12 py-16 bg-[#E9F3F2] flex-grow">
        ...
        <div className="md:w-1/2 mb-10 md:mb-0 flex justify-center">
          <img
            src={logo}
            alt="Helpyuva Logo"
            className="w-48 sm:w-64 lg:w-80 rounded-full shadow-2xl"
          />
        </div>
        ...
        <div className="md:w-1/2 text-center md:text-left">
          ...
          <p className="text-[#3D7072] text-base sm:text-lg leading-relaxed">
            We believe in <span className="font-semibold">“Seva with Sensitivity”</span> — empowering people
            with the right tools, education, and emotional support to create a
      ...
      <section className="px-6 sm:px-12 py-16 bg-white text-center">
        <h3 className="text-3xl sm:text-4xl font-bold tracking-tight text-[#3D7072] mb-8">
          Our Vision & Mission
        </h3>

        <div className="max-w-4xl mx-auto text-[#2E5658] text-base sm:text-lg leading-relaxed space-y-6">
          <p>
            Our <span className="font-semibold">vision</span> is to build a nation where every youth
            contributes towards social development, sustainability, and
            equality.
          </p>

          <p>
            Our <span className="font-semibold">mission</span> is to provide platforms for young
